...
def main(args=None):
    ...
    for epoch_num in range(parser.epochs):
        ...
        for iter_num, data in tqdm(enumerate(dataloader_train)):
            ...
            writer.add_scalar("Classification Loss/train", float(classification_loss), iter_num)
            writer.add_scalar("Regression Loss/train", float(regression_loss), iter_num)
            writer.add_scalar("Running Loss/train", np.mean(loss_hist), iter_num)
